    ...
    function loadUserData() {
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                ...
                document.getElementById('nombreUsuario').value = data.nombre_cliente;
                document.getElementById('apellidoUsuario').value = data.apellido_cliente;
                document.getElementById('cedulaUsuario').value = data.cedula_cliente;
                document.getElementById('telefonoUsuario').value = data.telefono_cliente;
                document.getElementById('correoUsuario').value = data.correo_cliente;
                document.getElementById('direccionUsuario').value = data.direccion_cliente;
                document.getElementById('contrasenaUsuario').value = data.contrasena_cliente;
...
function cerrarVentanaI() {
    ...
    window.location.href = "../MisServicios/MServicios.html";
}
