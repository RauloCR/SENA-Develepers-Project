...
// Obtener los datos del formulario
    ...
    $sql = "SELECT * FROM servicio WHERE type_machine = '$equipoFiltrado'";
    ...
    if ($result && $result->num_rows === 1) {
        ...
        $sql = "SELECT email_service, type_machine, destination_place, createTime_service, status_service FROM servicio WHERE type_machine = '$equipoFiltrado'";
        $result = $conn->query($sql);
