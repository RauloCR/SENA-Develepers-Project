...
$sql = "SELECT id_servicio, correo_servicio, tipo_equipo, destino_servicio, createTime_servicio, estado_servicio FROM servicio WHERE id_cliente = $userIdentificacioni";
